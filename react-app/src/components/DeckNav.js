...
export default function DeckNav() {
  ...
  const currentDeck = useSelector((state) => state.session?.user?.decks?.id);
    ...
    <>
      <Box>
        <Grid templateColumns="repeat(3, 1fr)" gap={6}>
          ...
          <Box align="center">
            {/* <Heading color="red.400">{currentDeck.deckName}</Heading> */}i
            just need something to render
          </Box>
        </Grid>
        ...
        >
          <Box align="center" h={50} mt={5}>
            ...
            <Heading size="md">
              {/* {" "}
                  {Object.keys(user.trunk_cards).length}{" "} */}
            </Heading>
          </Box>
