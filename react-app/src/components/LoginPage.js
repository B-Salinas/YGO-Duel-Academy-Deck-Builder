                ...
                <Box align={"center"} justify={"center"} direction={'column'} mt={8}>
                    <Text fontSize="4xl">
                        <Link href="/" _hover={{ color: "red.500", textDecoration: "none" }}>
                            <center> <strong> Log in to YGO DA Deck Builder</strong></center>
                        </Link>
                    </Text>
                </Box>
                    ...
                    <Box w={'800px'} >
                        <Flex align={"center"} justify={"center"} direction={'column'} mt={10} >
                            <Image
                                ...
                                src={"https://www.wikihow.com/images/thumb/1/18/Build-a-Beginner-Yu-Gi-Oh%21-Deck-Step-2-Version-2.jpg/v4-460px-Build-a-Beginner-Yu-Gi-Oh%21-Deck-Step-2-Version-2.jpg.webp"}
                                mb={'25px'}
                                w={'600px'}
                            >
                            </Image>
